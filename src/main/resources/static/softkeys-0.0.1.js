                ...
                case 'object' :
                    ...
                    case 'string' :
                        switch(button) {
                            ...
                            case 'return' :
                                character = '<span style="font-size: 26px; height:53px; width:112px;">Close</span>';
                                type = 'return';
                                break;
                            ...
                            case 'delete' :
                                character = '<span style="font-size: 23px; height:50px; width:74px; padding-top:1px;">delete</span>';
                                type = 'delete';
                                break;
